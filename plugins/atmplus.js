...
let handler = async (m, { conn, command, args }) => {
  ...
  if (global.db.data.users[m.sender].money >= moneyplus * count) {
    ...
    conn.reply(m.chat, `𝖣𝗂𝖺𝗆𝖻𝗂𝗅 𝖽𝖺𝗋𝗂 𝖣𝗈𝗆𝗉𝖾𝗍 :「Rp.${moneyplus * count}」💶\n𝖣𝗂𝗍𝖺𝖻𝗎𝗇𝗀 𝖪𝖾 𝖠𝗍𝗆 :「Rp.${count}」💰📃`, m)
  } else conn.reply(m.chat, `Money tidak mencukupi untuk menabung Rp.${count} ATM`, m)
}
